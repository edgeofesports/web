    ...
    <div className={styles.terms}>
      ...
      <section className={styles.section}>
        ...
        <ul className={styles.list}>
          ...
          <li>
            <strong>"Content"</strong> refers to all text, images, videos, and
            other materials provided on the website.
          </li>
        </ul>
      </section>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.paragraph}>
          ...
          website, you may need to register and create an account. You are
      ...
      <section className={styles.section}>
        ...
        <p className={styles.paragraph}>
          <strong>Acceptable Use:</strong> You agree to use the website only for
          lawful purposes. You must not use the website in any way that could
          damage, disable, overburden, or impair the website, or interfere with
          any other party's use of the website.
        </p>
        <p className={styles.paragraph}>
          <strong>Prohibited Activities:</strong> You must not engage in any of
        ...
        <ul className={styles.list}>
          ...
          <li>
            Engaging in any form of cheating, hacking, or exploiting bugs to
            gain an unfair advantage in tournaments or competitions.
          </li>
          <li>
            Attempting to gain unauthorized access to any part of the website,
            other user accounts, or computer systems connected to the website.
          </li>
        </ul>
      </section>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.paragraph}>
          <strong>Eligibility:</strong> Participation in tournaments and
          competitions may be subject to additional eligibility criteria, which
          will be provided at the time of registration.
        </p>
        <p className={styles.paragraph}>
          <strong>Rules:</strong> All participants must adhere to the specific
          rules and guidelines provided for each tournament or competition.
          Failure to comply may result in disqualification or other penalties.
        </p>
        <p className={styles.paragraph}>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.paragraph}>
          ...
          <a className={styles.link} href="/privacy">Privacy Policy</a> to understand how we collect, use, and
      ...
      <section className={styles.section}>
        ...
        <p className={styles.paragraph}>
          ...
          of the website, your violation of these terms, or your violation of
      ...
      <section className={styles.section}>
        ...
        <p className={styles.paragraph}>
          ...
          of law principles. Any legal action or proceeding related to your use
          of the website shall be brought exclusively in the courts of [Your
          Jurisdiction].
        </p>
      </section>
